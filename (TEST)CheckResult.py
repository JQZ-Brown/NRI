...
if args.save_folder:
    ...
    timestamp = "-test" # [Jiaqi Note] Avoid OSError
...
def test():
    ...
    for batch_idx, (data, relations) in enumerate(test_loader):
        ...
        mse_test.append(F.mse_loss(output, target).data.item())  #[Jiaqi Note] Avoid IndexError for 0-dim tensor
        nll_test.append(loss_nll.data.item())  #[Jiaqi Note] Avoid IndexError for 0-dim tensor
        kl_test.append(loss_kl.data.item())  #[Jiaqi Note] Avoid IndexError for 0-dim tensor
